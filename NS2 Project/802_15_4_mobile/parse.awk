...
END {
    ...
    print num "," (received_bytes * 8) / simulation_time>> str1".csv"
    print num "," (total_delay / received_packets)>> str2".csv"
    print num "," (received_packets / sent_packets)>> str3".csv"
    print num "," (dropped_packets / sent_packets)>> str4".csv"
    #print num "," (total_energy_consumption / received_packets)>> str5".csv"
    #print num "," (total_energy_consumption / received_bytes)>> str6".csv"
    print num "," (total_energy_consumption)>> str5".csv"
